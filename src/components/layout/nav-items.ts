...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/categories', label: 'Categories', icon: Tags, permission: PERMISSIONS.PRODUCT_VIEW },
  { href: '/brands', label: 'Brands', icon: Tag, permission: PERMISSIONS.PRODUCT_VIEW },
  ...
  { href: '/customers', label: 'Customers', icon: Contact, permission: PERMISSIONS.CUSTOMER_VIEW },
